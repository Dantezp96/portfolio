...
PROJECTS = [
    ...
    Project(
        ...
        short_description="Real-time sentiment analysis dashboard processing 10K+ tweets/min with transformer models.",
        full_description="Built an end-to-end sentiment analysis pipeline with a real-time dashboard. The system ingests Twitter data via streaming API, classifies sentiment using fine-tuned DistilBERT, and visualizes trends in an interactive Streamlit dashboard with geographic heatmaps.",
        category="NLP",
        tech_stack=["Python", "HuggingFace", "Streamlit", "Kafka", "PostgreSQL", "Docker"],
        ...
        repo_url="https://github.com/youruser/sentiment-dashboard",
        display_order=3,
        is_featured=True,
    ...
    Project(
        ...
        thumbnail_url="https://images.unsplash.com/photo-1509390874006-6c7f5e17d8c4?w=640&q=80",
        cover_image_url="https://images.unsplash.com/photo-1509390874006-6c7f5e17d8c4?w=1200&q=80",
