export const fallbackProjects = [
  ...
  },
  {
    ...
    full_description: "Scroll-driven analytics dashboard telling the story of UK solar power through data. Analyzes 162K data points (2015-2024) from Sheffield Solar/PV Live. Features 7 interactive sections: animated KPI cards, yearly capacity growth, generation patterns with zoomable charts, seasonal heatmaps (month x hour), capacity factor analysis, Prophet ML forecasting with decomposition, and environmental impact metrics (CO2, trees, homes powered). Pre-computed data pipeline in Python, fully static frontend.",
